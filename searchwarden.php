...
<input type="text" name="quer" placeholder="Type here..." required/></br></br>
<input type="submit" value="Search"/></br>
<a href="whome.php"><button type="button" class="cancelbtn">Cancel</button></a></br><br/></form>
</div>
</div></br>
<div class="card">
<div class="container">
<p><b>Options: </b></p>
<form>
<a href="formfill.php"><input type="button" value ="Add Student"></a>
<a href="deleteit.php"><input type="button" value ="Delete Student"></a>
<a href="editit.php"><input type="button" value ="Edit Student By ID"></a>
<a href="fileupload.php"><input type="button" value ="Add Student Photo By ID"></a>
</form>
</div>
</div>
</center>
