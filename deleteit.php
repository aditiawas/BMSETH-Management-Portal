...
<html lang="en">
<head>
  <title>Warden | Delete Student</title>
  <meta charset="utf-8">
...
<div class="card">
<div class="jumbotron">
    <p><b>Delete Student by ID</b></p>
</div>
<br/><br/>
<p>ID of the student you wish to delete:</p>
<form action="delete.php" onsubmit="return(verify());" method="POST">
<input type="text" name="delid" id="delid" placeholder="Enter here..." required/>
...
<a href="searchwarden.php"><button type="button" class="cancelbtn">Cancel</button></a>
  ...
  <script>
   function verify()
   {
       return(confirm("Do you really wish to delete the student with the ID "+document.getElementById('delid').value+"?"));
   }
   </script>
</center>
</body>
