...
<form action="leaveletter.php" method ="POST" onsubmit="f1();" >
<label style="float:left;">From date:<input type="date" name="from" required></label>
<label style="float:right;">To date:<input type="date" name="to" required></label></br></br><br/><br/><br/>
<label>Message</label><br/>
<textarea placeholder="Write your message here..." rows="10" cols="90" name="message" required>
</textarea> </br> </br>
