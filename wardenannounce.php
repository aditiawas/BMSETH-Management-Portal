...
<html lang="en">
<head>
  <title>Warden | Announcements</title>
  <meta charset="utf-8">
...
<div class="card">
<div class="jumbotron">
<p><b>Make the announcement</b></p>
</div>
<div class="container">
<form action="announceit.php" method="POST">
<input name="announce" type="text" placeholder="Type the announcement here..." required/></br></br>
<input type="submit" value="Submit"/>
<a href="whome.php"><button type="button" class="cancelbtn">Cancel</button></a>
</form>
</div>
</div>
</center>
