...
<table style="font-size:20px" cellpadding="20px"><tr><th><br/>
<?php
$id=$_SESSION['ID'];
...
while ($row=mysqli_fetch_array($result))
{
	 if ($row['ID']== $id)
	 {
	 echo 'ID: </th><td><br/>'.$row['ID'];
	 echo '</td></tr><tr><th><br/>Room No.: </th><td><br/>'.$row['Room No.'];
     echo '</td></tr><tr><th><br/>Name: </th><td><br/>'.$row['Name'];
	 echo '</td></tr><tr><th><br/>USN: </th><td><br/>'.$row['USN'];
	 echo '</td></tr><tr><th><br/>Branch: </th><td><br/>'.$row['Branch'];
     echo '</td></tr><tr><th><br/>Semester: </th><td><br/>'.$row['Semester'];
	 echo '</td></tr><tr><th><br/>Gender: </th><td><br/>'.$row['Gender'];
	 echo '</td></tr><tr><th><br/>DOB: </th><td><br/>'.$row['DOB'];
	 echo '</td></tr><tr><th><br/>Phone No.: </th><td><br/>'.$row['Phone No.'];
	 echo '</td></tr><tr><th><br/>Email ID: </th><td><br/>'.$row['Email ID'];
	 echo '</td></tr><tr><th><br/>Nationality: </th><td><br/>'.$row['Nationality'];
	 }
}
?>
</td></tr></table>
